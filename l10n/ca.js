OC.L10N.register(
    ...
    "The suspicious login app is enabled on this instance. It will keep track of IP addresses users successfully log in from and build a classifier that warns if a new login comes from a suspicious IP address." : "L'aplicació d'inici de sessió sospitosa està habilitada en aquesta instància. Mantindrà un registre de les adreces IP amb les quals els usuaris s'inicien amb èxit i crearà un classificador que avisi si un nou inici de sessió prové d'una adreça IP sospitosa.",
    "Training data statistics" : "Estadístiques de dades de formació",
    "So far the app has captured {total} logins (including client connections), of which {distinct} are distinct (IP, UID) tuples." : "Fins ara, l’aplicació ha capturat {total} inicis de sessió (incloent connexions de clients), dels quals {distinct} són parelles diferents (IP, UID).",
    "IPv4" : "IPv4",
    "IPv6" : "IPv6",
