OC.L10N.register(
    ...
    "No classifier model has been trained yet. This most likely means that you just enabled the app recently. Because the training of a model requires good data, the app waits until logins of at least {days} days have been captured." : "Ingen klassificeringsmodell har tränats än. Detta innebär sannolikt att du aktiverat appen nyligen. Eftersom träning av en modell kräver bra data väntar appen tills inloggningar av minst {dagar} dagar har loggats.",
