OC.L10N.register(
    ...
    "A new login into your account was detected. The IP address %s was classified as suspicious. If this was you, you can ignore this message. Otherwise you should change your password." : "偵測到您帳號有新的賬戶登入活動。此IP位址%s歸類為可疑。 如果是您本人的登入活動，可以忽略此訊息。否則您應更改密碼。",
    ...
    "The suspicious login app is enabled on this instance. It will keep track of IP addresses users successfully log in from and build a classifier that warns if a new login comes from a suspicious IP address." : "此為偵測可疑帳號登入活動的實用App。它將追蹤成功登入賬戶的IP位址，並構建分類器，如果新帳號登入來自可疑IP位址，則該分類器將發出警示。",
