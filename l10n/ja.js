OC.L10N.register(
    "suspicious_login",
    {
    "Suspicious Login" : "不正なログイン",
    "New login detected" : "新しいログインが検出されました",
    "A new login into your account was detected. The IP address %s was classified as suspicious. If this was you, you can ignore this message. Otherwise you should change your password." : "アカウントへの新しいログインが検出されました。 IP アドレス%sは疑わしいものとして分類します。このログインがあなたであればこのメッセージは無視して構いません。そうでない場合は、パスワードを変更してください。",
    "Detect and warn about suspicious IPs logging into Nextcloud\n\t" : "Nextcloudにログインする不審なIPを検出して警告します\n\t",
    "Suspicious login detection" : "不正なログインが検出されました",
    "The suspicious login app is enabled on this instance. It will keep track of IP addresses users successfully log in from and build a classifier that warns if a new login comes from a suspicious IP address." : "このインスタンスで不審なログインアプリケーションが有効になっています。ユーザーが正常にログインしたIPアドレスを追跡し、疑わしいIPアドレスから新しいログインがあった場合に警告する分類モデルを構築します。",
