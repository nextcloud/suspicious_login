OC.L10N.register(
    ...
    "A new login into your account was detected. The IP address %s was classified as suspicious. If this was you, you can ignore this message. Otherwise you should change your password." : "Une nouvelle connexion avec votre compte a été détectée. L'adresse IP %s a été considérée comme suspecte. S'il s'agissait de vous, vous pouvez ignorer ce message. Sinon, vous devriez changer votre mot de passe.",
    "Detect and warn about suspicious IPs logging into Nextcloud\n\t" : "Détecte et avertit des IPs suspectes se connectant à Nextcloud",
    "Suspicious login detection" : "Détection d'une connexion suspecte",
    ...
    "During evaluation, the latest model (trained {time}) has shown to capture {recall}% of all suspicious logins (recall), whereas {precision}% of the logins classified as suspicious are indeed suspicious (precision). Below you see a visualization of historic model performance." : "Lors de l'évaluation, le dernier modèle (formé {heure}) a montré qu'il capturait {rappel}% de toutes les connexions suspectes (rappel), alors que {précision}% des connexions classifiées comme suspectes étaient effectivement suspectes (précision). Ci-dessous, vous voyez une visualisation de la performance d'un modèle historique.",
    "Precision" : "Précision",
    "Recall" : "Rappeler"
},
