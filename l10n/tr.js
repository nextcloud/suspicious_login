OC.L10N.register(
    ...
    "The suspicious login app is enabled on this instance. It will keep track of IP addresses users successfully log in from and build a classifier that warns if a new login comes from a suspicious IP address." : "Bu Nextcloud kopyasında şüpheli oturum açma uygulaması etkinleştirilmiş. Bu uygulama kullanıcıların oturum açtığı IP adreslerini izler ve bir sınıflayıcı ile değerlendirerek şüpheli bir IP adresinden açılan oturumlarla ilgili uyarıda bulunur.",
