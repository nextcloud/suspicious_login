OC.L10N.register(
    ...
    "So far the app has captured {total} logins (including client connections), of which {distinct} are distinct (IP, UID) tuples." : "Doposiaľ aplikácia zaznamenala {total} prihlásení (vrátane klientskych pripojení), z ktorých {distinct} sú odlišné (IP, UID) n-tice.",
    "IPv4" : "Adresa IPv4",
    "IPv6" : "Adresa IPv6",
